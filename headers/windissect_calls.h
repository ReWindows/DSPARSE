...
static constexpr wchar_t module_name[12] = {0x0044, 0x0053, 0x0050, 0x0041, 0x0052, 0x0053, 0x0045, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 3779774972U || rva >= image_size) return nullptr;
return base + rva;
}
