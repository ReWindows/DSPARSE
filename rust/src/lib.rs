//! Windissect-generated Rust FFI bindings for DSPARSE.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "8FA49081BBE43D8CBFF3D9797D087DB2";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 3779774972;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 12] = [68, 83, 80, 65, 82, 83, 69, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 3779774972 { return 0; }
